...
subtest 'invalid method names are rejected' => sub {
  like dies { ValueObject::JSONRPC::MethodName->new(value => '') }, qr/JSON-RPC method name/, 'empty string rejected';

  like dies { ValueObject::JSONRPC::MethodName->new(value => []) }, qr/JSON-RPC method name/, 'non-scalar rejected';

  like dies { ValueObject::JSONRPC::MethodName->new(value => 'rpc.test') }, qr/JSON-RPC method name/,
    'names starting with "rpc." rejected';

  like dies { ValueObject::JSONRPC::MethodName->new(value => 1) }, qr/JSON-RPC method name/, 'numeric value rejected';
};
