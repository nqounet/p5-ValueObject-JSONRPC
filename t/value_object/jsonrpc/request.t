...
subtest 'Request construction and equality' => sub {
  ...
  like dies { ValueObject::JSONRPC::Request->new(method => $m, params => $p) },
    qr/JSON-RPC request id|Missing required arguments/, 'request without id rejected';
  ...
  }, qr/JSON-RPC request id MUST NOT be null/, 'request with null id rejected';
};
